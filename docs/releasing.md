...
## 0.2.2 release verification

The 0.2.2 metadata and release notes describe the reviewed patch candidate.
Confirm the `v0.2.2` GitHub release and successful TestPyPI/PyPI verification
jobs before recording 0.2.2 as released or pinning it in a deployed consumer.
