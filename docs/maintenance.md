...
and `uv.lock` stay consistent; GitHub Actions updates are also weekly. The
plan originally said pip, but this repository uses uv's lock format and
Dependabot now supports it directly.
